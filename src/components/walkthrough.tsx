...
const stages = {
  ...
  next: {
    ...
    copy: "You prove it’s you again with World ID, and your losses carry over, no account needed. A real World ID brings them with a passkey on your phone. Five of the eleven chances are yours: 45.5% odds. Extra chances improve your odds, but never guarantee a win.",
