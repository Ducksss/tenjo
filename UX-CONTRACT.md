...
4. **How it works** (src/components/walkthrough.tsx): the interactive walkthrough, four steps from verify and enter to collect. Its World ID note names the configured credential, and its last step hands back to the real drop.
