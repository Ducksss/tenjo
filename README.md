...
See [PRD](docs/PRD.md), [implementation decisions](docs/IMPLEMENTATION.md), [design](DESIGN.md) and [UX contract](UX-CONTRACT.md).
...
- [ ] Two clean four-minute rehearsals, recording, measured debrief, public repository and ETHGlobal submission.
